                        ...
                        <div class="subscribe scrollme">
                            <div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
                                ...
                                <form class="subscribe-form" action="/subscribe" method="get">
                                    ...
                                    <button class="subscr-btn" type="submit" name="submit">subscribe
...
<!-- End Footer -->
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5a987e70d1b54725"></script>
